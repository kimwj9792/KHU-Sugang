            ...
            <div class="login-content">
                <form class="margin-bottom-0" method="POST" action="/login">
                    <div class="form-group m-b-15">
                        <input type="text" name="id" class="form-control input-lg" maxlength="10" placeholder="아이디" disabled required>
                    </div>
                    <div class="form-group m-b-15">
                        <input type="password" name="pw" class="form-control input-lg" maxlength="20" placeholder="비밀번호" disabled required>
                    </div>
                    <div class="checkbox m-b-30">
                        <label>
                            <input type="checkbox" name="ok" value="ok" disabled required> 종합정보시스템의 수강내역목록 접근에 동의합니다.
                        </label>
                    </div>
                    <div class="login-buttons">
                        <button type="submit" class="btn btn-success btn-block btn-lg" disabled>로그인</button>
                    </div>
