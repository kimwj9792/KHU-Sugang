...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "http://163.180.96.142/servlets/timetable?attribute=search_kor");
...
curl_close($ch);
$temp1_s = explode('/html/js/top/top_', $result_s);
for ($i_s=1; $i_s<count($temp1_s); $i_s++) {
    $temp2_s = explode('_kor.js', $temp1_s[$i_s]);
    $year = substr($temp2_s[0], 0, 4);
    $term = substr($temp2_s[0], 4, 2);
    $ch = curl_init();
